...
//   // Define the size of the source image and destination canvas
//   const imageSize = sourceCanvas.width;
//   const canvasSize = imageSize * 2;

//   // Set the dimensions of the destination canvas
//   destinationCanvas.width = canvasSize;
//   destinationCanvas.height = canvasSize;
